...
if __name__ == '__main__':
    ...
    parser.add_argument('--file_name', type=str,  help='audio file name')
    parser.add_argument('--epoch_name', type=str,  help='generator epoch name')

    
    opt = parser.parse_args()
    opt.file_name = 'data/noisy_testset_wav/p232_001.wav'
    opt.epoch_name = 'generator-4.pkl'
